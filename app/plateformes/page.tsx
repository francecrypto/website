...
const platforms = [
  ...
  { name: "Arkham Exchange", company: "Arkham Markets International, S.R.L", address: "Punta Cana, République dominicaine", website: "http://arkm.com/" },
  ...
  { name: "Bitpanda", company: "Bitpanda GmbH", address: "Stella-Klein-Low Weg 17, 1020 Vienne, Autriche", source: "Page « Mentions légales » de Bitpanda", website: "https://www.bitpanda.com/fr", mica: true },
  ...
  { name: "Bitstamp", company: "Bitstamp Europe S.A.", address: "40, avenue Monterey, Luxembourg, L-2163, Luxembourg", source: "https://www.bitstamp.net/legal/europe-sa/", website: "https://www.bitstamp.net/", byRobinhood: true, mica: true },
  { name: "Bitstack", company: "Bitstack France", address: "France", source: "Liste des PSAN enregistrés auprès de l'AMF", website: "https://bitstack-app.com", mica: true },
  { name: "Bitvavo", company: "Bitvavo B.V.", address: "Keizersgracht 281, 1016 ED Amsterdam, Pays-Bas", source: "Page « About » de Bitvavo", website: "https://www.bitvavo.com/", mica: true },
  ...
  { name: "Bullish", company: "Bullish (GI) Limited", address: "26/F, The Centrium, 60 Wyndham Street, Central, Hong Kong", source: "Pied de page de la page d'accueil de Bullish", website: "https://bullish.com/", mica: true },
  { name: "Bybit", company: "Bybit Fintech Limited", address: "C/O Campbells, Floor 2 Romasco Place, Road Town, Tortola, Îles Vierges britanniques", source: "Page Bybit de Dun & Bradsheet", website: "https://www.bybit.com/", mica: true },
  ...
  { name: "Coinbase", company: "Coinbase Europe Limited", address: "70 Sir John Rogerson's Quay, Dublin D02 R296, Irlande", source: "Page des mentions légales de Coinbase", website: "https://coinbase.com/join/7VVCUYL?src=referral-link", mica: true },
  ...
  { name: "Crypto.com", company: "Foris DAX MT Limited", address: "Level 7, Spinola Park, Triq Mikiel Ang Borg, St. Julian's SPK 1000, Malte", source: "Page Privacy de Crypto.com", website: "https://crypto.com/app/rxevtcn6q6", mica: true },
  ...
  { name: "eToro", company: "eToro (Europe) Ltd", address: "4 Profiti Ilia Street, Kanika International Business Center (KIBC) 7th Floor, Germasogeia 4046, Limassol, Chypre", source: "Page « Our Offices » de eToro", website: "https://www.etoro.com/", mica: true },
  { name: "Finst", company: "Finst", address: "Herengracht 454, 1017 CA Amsterdam, Pays-Bas", source: "CGU de Finst", website: "https://www.finst.com/", mica: true },
  { name: "Gate (ex Gate.io)", company: "Gate.com", address: "P.O. Box 31119 Grand Pavilion, Hibiscus Way, 802 West Bay Road, Grand Cayman, KY1-1205, Îles Caïmans", source: "Page LinkedIn de Gate.io", website: "https://www.gate.io/", mica: true },
  ...
  { name: "Gemini", company: "Gemini Intergalactic Europe Limited", address: "70 Sir John Rogerson's Quay, Dublin 2, Irlande", source: "Page Privacy Policy de Gemini", website: "https://www.gemini.com/", mica: true },
  ...
  { name: "Kraken", company: "Payward Ireland Limited", address: "70 Sir John Rogerson's Quay, Dublin Docklands, Dublin 2, Ireland D02 R296", source: "Publication officielle sur les adresses de Kraken", website: "https://www.kraken.com/", mica: true },
  { name: "KuCoin", company: "Vistra Corporate Services Centre", address: "Suite 23, 1er étage, Eden Plaza, Eden Island, Mahé, Seychelles", source: "Demande au support de KuCoin", website: "https://www.kucoin.com/r/rf/QBSWC8SX", welcomeBonus: "Tokens USDT", mica: true },
  ...
  { name: "MEXC", company: "MEXC Global Ltd", address: "Sertus Chambers, Second Floor, The Quadrant, Manglier Street, Victoria, Mahé, Seychelles", source: "Page LinkedIn de MEXC", website: "https://www.mexc.com/auth/signup?inviteCode=1JygR", welcomeBonus: "20 USDT" },
  ...
  { name: "Nexo", company: "Nexo AG", address: "15 Grafenaustrasse, 6300 Zug, Suisse", source: "Page de Nexo sur Craft.co", website: "https://nexo.com/", welcomeBonus: "0.5% de votre balance moyenne des 30 premiers jours en BTC", welcomeBonusDetail: "Ajoutez 5 000 $+ en actifs numériques dans les 30 jours. Si vous maintenez ou augmentez le solde de votre portefeuille au cours des 30 jours suivants, vous êtes éligible aux récompenses. Recevez un bonus allant jusqu'à 5 000 $ en BTC, basé sur votre solde moyen de portefeuille sur 30 jours" },,,
  { name: "OKX (ex OKCoin)", company: "OKCoin Europe LTD", address: "30, Kenilworth, Flat 3, Sir Augustus Bartolo Street, Ta Xbiex XBX 1093, Malte", source: "Page des licences de OKCoin", website: "https://www.okcoin.com/", mica: true },
  ...
  { name: "Stackinsat", company: "Stackinsat", address: "France", source: "Liste des PSAN enregistrés auprès de l'AMF", website: "https://app.stackinsat.com/signup?r=UIPTV9TJ", micaPending: true },
  { name: "SwissBorg", company: "SBorg SA", address: "8 rue du Grand-Chêne, 1003 Lausanne, Suisse", source: "Page d'accueil de SwissBorg", website: "https://swissborg.com/", mica: true },
  { name: "Trade Republic", company: "Trade Republic Bank GmbH", address: "Köpenicker Strasse 40c 10179, Allemagne", source: "Mentions légales de Trade Republic", website: "https://traderepublic.com/", mica: true },
  ...
  { name: "WhiteBIT", company: "UAB Clear White Technologies", address: "26, J. Basanaviciaus Street, Vilnius, Lituanie", source: "Page « User Agreement » de WhiteBIT", website: "https://whitebit.com/", mica: true },
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-950">
        <div className="container px-4 md:px-6">
          ...
          <div className="mb-12 max-w-3xl mx-auto space-y-6">
            <h2 className="text-2xl font-bold text-center text-blue-700 dark:text-blue-300">Plateformes d'échange crypto de référence</h2>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white dark:from-gray-900 dark:to-gray-950 p-6 rounded-lg shadow-lg border-2 border-blue-300">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold rounded bg-indigo-100 text-indigo-700 border border-indigo-200" title="Prestataire agréé MiCA (CASP) dans l'UE">
              ...
              <div className="mb-3 px-3 py-2 bg-green-100 text-green-800 rounded-md inline-block font-semibold">
                🎁 20€ en cadeau de bienvenue
              </div>
              <p className="text-sm text-gray-700 dark:text-gray-300">
                <strong>Analyse :</strong> Coinbase, créé en 2012 et coté au Nasdaq (symbole : COIN), est l'un des exchanges les plus sûrs et transparents, régulé aux États-Unis. Il offre une interface fiable, conforme aux normes financières, idéale pour les investisseurs particuliers et institutionnels.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white dark:from-gray-900 dark:to-gray-950 p-6 rounded-lg shadow-lg border-2 border-blue-300">
              ...
              <div className="mb-3 px-3 py-2 bg-green-100 text-green-800 rounded-md inline-block font-semibold">
                🎁 Bonus 50€ de bienvenue
              </div>
              <p className="text-sm text-gray-700 dark:text-gray-300">
                <strong>Analyse :</strong> Crypto.com, fondée en 2016 et basée à Singapour, s'est imposée comme une plateforme complète. Elle se distingue par sa carte Visa crypto, et ses services intégrés (staking, cashback, NFT) encadrés par plusieurs licences.
              </p>
            </div>
          </div>
              ...
              {platforms.map((p, i) => (
                <li key={i} className="bg-white dark:bg-gray-950 p-6 rounded-lg shadow-md flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    {p.mica && (
                      <span className="ml-2 inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold rounded bg-indigo-100 text-indigo-700 border border-indigo-200" title="Prestataire agréé MiCA (CASP) dans l'UE">
                        <ShieldCheck className="h-3.5 w-3.5" />
                        MiCA
                      </span>
                    )}
                    {p.micaPending && (
                      <span className="ml-2 inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold rounded bg-amber-100 text-amber-700 border border-amber-200" title="Demande d'agrément MiCA (CASP) en cours">
          ...
          <div className="mt-12 p-4 rounded-lg bg-blue-50 border border-blue-200 text-blue-900 text-center max-w-3xl mx-auto">
            La liste complète des prestataires agréés MiCA (CASP) est disponible dans le registre officiel de l'ESMA :{' '}
            <a href="https://www.esma.europa.eu/esmas-activities/digital-finance-and-innovation/markets-crypto-assets-regulation-mica" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline font-bold inline-flex items-center gap-1">
              Registre MiCA de l'ESMA
